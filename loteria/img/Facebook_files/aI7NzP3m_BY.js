...
__d("AYMTMultiTipLogger",["Event","AsyncRequest","XAYMTMultiTipAsyncClickControllerURIBuilder","$","LoadingIndicator.react","React"],function(a,b,c,d,e,f,g,h,i,j,k,l){var m={init:function(n,o,p,q,r){g.listen(n,'click',function(event){if(r!==null)l.renderComponent(l.createElement(k,{size:"large",color:"white"}),j(r));var s=new i().setString('tip_id',o).setString('channel_id',p).setString('target',q).getURI();new h(s).send();});}};e.exports=m;},null);